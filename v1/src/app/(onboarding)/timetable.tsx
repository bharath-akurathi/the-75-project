...
import { addSubject, addSlot, getAllSubjects, getAllSlots } from '@/database/queries';
...
import type { Subject, TimetableSlotWithSubject } from '@/database/queries';
...
export default function TimetableScreen() {
  ...
  const handleJsonImport = async (jsonString: string) => {
    ...
    try {
      ...
      Alert.alert('Import Error', 'Failed to import timetable. Please try again.');
    }
  };
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.optionsRow}>
          ...
          >
            ...
            <Text style={styles.optionButtonSub}>Add one-by-one</Text>
          </TouchableOpacity>
        </View>

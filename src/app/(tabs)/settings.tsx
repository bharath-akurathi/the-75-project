...
import type { Subject, TimetableSlotWithSubject, UserPreferences, PeriodTiming } from '@/database/queries';
...
export default function SettingsScreen() {
  ...
  const [addSlotSubjectId, setAddSlotSubjectId] = useState<number | null>(null);

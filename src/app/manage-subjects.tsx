...
import { getAllSubjects, addSubject, renameSubject, deleteSubject, updateSubjectOffsets, getPreferences, type Subject } from '@/lib/database/queries';
import { calculatePerSubject, type SubjectResult } from '@/lib/database/calculations';
...
export default function ManageSubjectsScreen() {
  ...
  const handleManualOffset = async (subjectId: string, heldChange: number, attendedChange: number) => {
